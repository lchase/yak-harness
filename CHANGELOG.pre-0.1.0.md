...
Frozen history of the v1 build, which predates the release pipeline.
From v0.1.0 on see [`CHANGELOG.md`](CHANGELOG.md) (release-please
generated). Git history is authoritative.
